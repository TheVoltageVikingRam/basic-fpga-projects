...
HD_PWD='C:/Users/admin/Verilog_Ram/basic-fpga-projects/sub_2bit/sub_2bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_2bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sub_2bit.tcl -notrace
