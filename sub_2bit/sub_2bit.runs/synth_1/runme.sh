...
HD_PWD='C:/Users/admin/Verilog_Ram/basic-fpga-projects/sub_2bit/sub_2bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_2bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sub_2bit.tcl
